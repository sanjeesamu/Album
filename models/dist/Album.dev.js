...
var genres = ['Pop', 'Rock', 'Jazz', 'Classical', 'Hip-Hop', 'Blues', 'Electronic', 'Country', 'Reggae', 'Jazz Rock'];
var albumSchema = new mongoose.Schema({
  ...
  year: {
    ...
    max: [currentYear, "Release year cannot be later than ".concat(currentYear)]
  },
  genre: {
    type: String,
